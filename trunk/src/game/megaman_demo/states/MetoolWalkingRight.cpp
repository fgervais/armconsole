...
MetoolState* MetoolWalkingRight::getInstance() {
	...
	//if(sharedFrames == 0) {
		...
		animationFrames[0] = new Bitmap("0:state/MetoolWalkingRight/1.bmp");
		animationFrames[1] = new Bitmap("0:state/MetoolWalkingRight/2.bmp");
		animationFrames[2] = new Bitmap("0:state/MetoolWalkingRight/3.bmp");
		animationFrames[3] = new Bitmap("0:state/MetoolWalkingRight/4.bmp");
		//instance = new MetoolWalkingRight(22, 21, frames, 4);
	//}
	//if(sharedMasks == 0) {
		Bitmap** animationMasks = new Bitmap*[4];
		//sharedMasks = new Bitmap*[4];
		animationMasks[0] = new Bitmap("0:state/MetoolWalkingRight/mask1.bmp");
		animationMasks[1] = new Bitmap("0:state/MetoolWalkingRight/mask2.bmp");
		animationMasks[2] = new Bitmap("0:state/MetoolWalkingRight/mask3.bmp");
		animationMasks[3] = new Bitmap("0:state/MetoolWalkingRight/mask4.bmp");
