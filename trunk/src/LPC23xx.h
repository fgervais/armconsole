 ...
 *   2010.01.25  ver 1.01    Modified by Francois Gervais
 *
******************************************************************************/
...
/*
 * OHCI register structure
 *
 * Some of this is based on the OHCI implementation of the linux kernel.
 */
typedef struct
{
...
#define OHCI_BASE		0xFFE0C000

/* OHCI declaration */
#define OHCI			(((OHCI_Typedef *) OHCI_BASE))

/*
 * OHCI CONTROL AND STATUS REGISTER MASKS
 *
 * This is coming from ohci.h of the linux kernel.
 */
