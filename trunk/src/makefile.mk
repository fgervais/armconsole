...
# Modified for LPC2400 ARM7 devices
# by Francois Gervais, December 2009
#
...
ASRCARM  = $(LOWLEVEL)/src/startup.S
ASRCARM += $(LOWLEVEL)/src/swi_handler.S
...
LDFLAGS +=-T$(LINKERSCRIPTPATH)lpc2478_rom.ld
